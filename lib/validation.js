...
export function validateStep3(data) {
  ...
  const income = parseFloat((data.monthly_income || "").replace(/,/g, ""));
if (!data.monthly_income || isNaN(income))
  errors.monthly_income = "Monthly income is required";
else if (income < 100)
  errors.monthly_income = "Please enter a valid monthly income (minimum $100)";
